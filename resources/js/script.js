...
function toggleMode() {
  ...
  if (color === 'rgb(0, 0, 0)') {
    ...
    for (i = 0; i < symbols.length; i++) {
      symbols[i].style.color = 'white';
    }
    mode.style.background = 'rgb(0, 20, 74)';
    mode.innerHTML = '🌙';
  }
}


// SHOW BACK-TO-TOP AND MODE BUTTONS ON SCROLL
window.onscroll = function() {scrollFunction()};
function scrollFunction() {
  let wrapper = document.querySelector('.buttons-wrapper');
...
function copy(elementId) {
  ...
  // copied.style.animation = 'fadeOut 3s ease .5s';
  // setTimeout(function() {
...
// ANIMATE FAVICON
let favicon_images = ['./resources/images/output/tmp-0.gif','./resources/images/output/tmp-1.gif','./resources/images/output/tmp-2.gif','./resources/images/output/tmp-3.gif','./resources/images/output/tmp-4.gif','./resources/images/output/tmp-5.gif','./resources/images/output/tmp-6.gif','./resources/images/output/tmp-7.gif','./resources/images/output/tmp-8.gif','./resources/images/output/tmp-9.gif','./resources/images/output/tmp-10.gif','./resources/images/output/tmp-11.gif','./resources/images/output/tmp-12.gif','./resources/images/output/tmp-13.gif','./resources/images/output/tmp-14.gif','./resources/images/output/tmp-15.gif','./resources/images/output/tmp-16.gif','./resources/images/output/tmp-17.gif','./resources/images/output/tmp-18.gif','./resources/images/output/tmp-19.gif','./resources/images/output/tmp-20.gif','./resources/images/output/tmp-21.gif','./resources/images/output/tmp-22.gif','./resources/images/output/tmp-23.gif','./resources/images/output/tmp-24.gif','./resources/images/output/tmp-25.gif','./resources/images/output/tmp-26.gif','./resources/images/output/tmp-27.gif','./resources/images/output/tmp-28.gif','./resources/images/output/tmp-29.gif','./resources/images/output/tmp-30.gif','./resources/images/output/tmp-31.gif','./resources/images/output/tmp-32.gif','./resources/images/output/tmp-33.gif'],
